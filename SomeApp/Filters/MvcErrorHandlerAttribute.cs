...
namespace SomeApp.Filters
{
    ...
    internal class MvcErrorHandlerAttribute : HandleErrorAttribute
    {
        ...
        /// Logging.
        /// </summary>
        private static readonly ILog Log = LogManager.GetLogger<MvcErrorHandlerAttribute>();
        ...
        public override void OnException(ExceptionContext filterContext)
        {
            if (filterContext != null && !filterContext.ExceptionHandled)
            {
                ...
                Log.Error($"An unhandled error occurred while processing action {actionName} on controller {controllerName}.", filterContext.Exception);
            }
