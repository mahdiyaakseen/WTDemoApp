...
namespace SomeApp
{
    ...
    public partial class Startup
    {
        ...
        {
            Log.Debug("Configuring OAuth token store.");
            ...
            Log.Debug("Configuring application cookie authentication.");
            ...
            Log.Debug("Configuring login provider.");
            ...
            Log.Debug("Configuring Data Core client to use OAuth authentication.");
